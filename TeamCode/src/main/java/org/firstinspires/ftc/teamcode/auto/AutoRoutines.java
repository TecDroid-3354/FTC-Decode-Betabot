...
class Blue9Plus3 extends CommandOpMode {
    ...
    public void autonomousPathUpdates() {
        switch (pathState) {
            ...
            case 1:
                if (!follower.isBusy()) {
                    follower.followPath(paths.blue9Plus3PickFirstRow);
                    setPathState(2);
                }
                break;
            case 2:
                if (!follower.isBusy()) {
                    follower.followPath(paths.blue9Plus3ShootFirstRow);
                    setPathState(3);
                }
                break;
            case 3:
                if (!follower.isBusy()) {
                    follower.followPath(paths.blue9Plus3PickSecondRow);
                    setPathState(4);
                }
                break;
            case 4:
                if (!follower.isBusy()) {
                    follower.followPath(paths.blue9Plus3ShootSecondRow);
                    setPathState(5);
                }
                break;
            case 5:
                if (!follower.isBusy()) {
                    follower.followPath(paths.blue9Plus3PickThirdRow);
                    setPathState(6);
                }
                break;
            case 6:
                if (!follower.isBusy()) {
                    follower.followPath(paths.blue9Plus3End);
                    setPathState(7);
                }
                break;
        }
