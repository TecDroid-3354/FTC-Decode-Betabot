...
class ColorCalibrationOpModes : LinearOpMode() {
    ...
    override fun runOpMode() {
        FrontSlot = ColorCalibrationJSON(Ids.frontSlotLeftSensor, Extensions.frontSlotExtension, telemetry, hardwareMap, gamepad1)
        MiddleSlot = ColorCalibrationJSON(Ids.middleSlotLeftSensor, Extensions.middleSlotExtension, telemetry, hardwareMap, gamepad1)
        BackSlot = ColorCalibrationJSON(Ids.backSlotLeftSensor, Extensions.backSlotExtension, telemetry, hardwareMap, gamepad1)
