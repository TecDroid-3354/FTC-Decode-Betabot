...
public class red6Plus3 extends CommandOpMode{
    //Pedro ´Pathing
    ...
    public void initialize() {
        ...
        follower.setStartingPose(paths.red6Plus3Poses.red6Plus3ShootingPose);
    }
    ...
    public void autonomousPathUpdates() {
        switch (pathState){
            //Go to the point to
            case 0:
                follower.followPath(paths.red6Plus3ShootPrecharged,true);
                setPathState(1);
            break;
            ...
            case 2:
                ...
                follower.followPath(paths.red6Plus3PickRowOne,true);
                setPathState(3);
            break;

            case 3:
                intake.stopBothIntakes();
                follower.followPath(paths.red6Plus3ShootRowOne,true);
                setPathState(4);
            break;
            ...
            case 5:
                intake.enableBothIntakes();
                follower.followPath(paths.red6Plus3PickRowTwo,true);
                setPathState(6);
            break;

            case 6:
                intake.stopBothIntakes();
                follower.followPath(paths.red6Plus3ShootRowTwo, true);
                setPathState(7);
            break;
